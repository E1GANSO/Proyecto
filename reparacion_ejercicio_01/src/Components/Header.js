    ...
    return(
        <Row id="Color_Head">
            <Col>
             ...
             <Col>
                <p> 
                    <Link to= '/AddProduct' id="Color_Text"> 
            ...
            <Col>
                <p> 
                    <Link to = '/Cartproduct' id="Color_Text"> <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-cart4" viewBox="0 0 16 16">
